% Test EpiSmoother vs APE on general scenarios
...
for i = 1:len
    % EpiFilter method
    [~, ~, ~, ~, pR, pRup, pstate] = runEpiFilterSm(Rgrid, m, eta, nday, p0, Lam{i}, Iday{i});
    % EpiSmoother estimates for this trajectory
    [Rmed{i}, Rlow{i}, Rhigh{i}, Rmean{i}, qR] = runEpiSmoother(Rgrid, m, nday, pR, pRup, pstate);
end
