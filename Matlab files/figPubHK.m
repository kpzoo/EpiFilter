...
% Additional HK intervention indices
if scenNo == 2
    int1 = datetime('13-07-20', 'InputFormat', 'dd-MM-yy');
    idint1 = find(int1 == tdates);
end
...
plot(xval(idint1)*ones(1, 2), yrange, '-', 'Color', grey2, 'LineWidth', 2);
